...
class PHPCmdHelper(object):
    ...
    def setup_command_line(parser):
        ...
        """
        parser.add_argument('pigeons', metavar='<pigeons>',
                            type=int, help="Number of pigeons")
        parser.add_argument('holes', metavar='<holes>',
                            type=int, help="Number of holes")
            ...
            for p2 in range(p1):
                for i1 in range(items):
                    for i2 in range(items):
                        php.add_clause(
                            [(False, var(p1, i1, h)), (False, var(p2, i2, h))])
...
class HPHPCmdHelper(object):
    ...
    def setup_command_line(parser):
        ...
        parser.add_argument('pigeons', metavar='<pigeons>',
                            type=int, help="Number of pigeons")
        parser.add_argument('items', metavar='<items>',
                            type=int, help="Number of items per pigeon")
        parser.add_argument('holes', metavar='<holes>',
                            type=int, help="Number of holes")
