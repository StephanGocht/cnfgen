...
class TestReshuffler(TestCNFBase):
    ...
    def test_variable_permutation(self):
        ...
        self.assertSequenceEqual(
            list(shuffle.variables()), variables_permutation)
    ...
    def test_inverse(self):
        ...
        variables_permutation = list(range(10))
        ...
        new_variables = [old_variables[sigma_i]
                         for sigma_i in variables_permutation]
        ...
        i_clauses_permutation = self.inverse_permutation(
...
class TestDimacsReshuffler(TestCNFBase):
    ...
    def test_identity_equivalence(self):
        ...
        constraints_permutation = list(range(2))
        polarity_flip = [1]*3
        self.equivalence_check_helper(
            cnf, variable_permutation, constraints_permutation, polarity_flip)
    ...
    def test_random_equivalence_small(self):
        ...
        constraints_permutation = list(range(10))
        random.shuffle(constraints_permutation)
