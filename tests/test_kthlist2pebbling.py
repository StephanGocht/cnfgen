...
class TestKTHList2Pebbling(TestCommandline):
    ...
    def test_unit_graph(self):
        ...
        input.seek(0)
        self.checkFormula(
            input, F, ["kthlist2pebbling", "-q", "none"], cmdline=kthlist2pebbling)
    ...
    def test_or_substitution(self):
        ...
        input.seek(0)
        self.checkFormula(
            input, F, ["kthlist2pebbling", "-q", "or", 2], cmdline=kthlist2pebbling)
    ...
    def test_lift_substitution(self):
        ...
        input.seek(0)
        self.checkFormula(
            input, F, ["kthlist2pebbling", "-q", "lift", 3], cmdline=kthlist2pebbling)
    ...
    def test_xor_substitution(self):
        ...
        input.seek(0)
        self.checkFormula(
            input, F, ["kthlist2pebbling", "-q", "xor", 2], cmdline=kthlist2pebbling)
